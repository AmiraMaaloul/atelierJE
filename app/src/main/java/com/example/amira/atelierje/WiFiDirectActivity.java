 ...
 */
public class WiFiDirectActivity extends AppCompatActivity implements ChannelListener, DeviceActionListener, DownloadCallback {
    ...
    public static final String TAG = "atelierje";
    ...
    public void resetData() {
        ...
        VideoFragment fragmentVideo = (VideoFragment) getFragmentManager()
                .findFragmentById(R.id.frag_video);
        if (fragmentList != null) {
            fragmentList.clearPeers();
        }
        if (fragmentVideo != null) {
            fragmentVideo.resetViews();
        }
    }
    ...
    public void disconnect() {
        final VideoFragment fragment = (VideoFragment) getFragmentManager()
                .findFragmentById(R.id.frag_video);
        fragment.resetViews();
